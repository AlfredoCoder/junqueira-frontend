...
class SAFTService {
      ...
      return {
        ...
        data: {
          ...
          contacts: {
            ...
            fax: '',
            email: 'info@Complexo Abilio Junqueira.ao',
            website: 'www.Complexo Abilio Junqueira.ao'
          },
  ...
  private generateHeader(config: ISAFTExportConfig, companyData: any): ISAFTHeader {
    ...
    return {
      ...
      headerComment: 'Ficheiro SAFT-AO gerado pelo Sistema Complexo Abilio Junqueira - Conforme Decreto Executivo 74/19'
    };
  }
  ...
  private createMockSAFTStructure(config: ISAFTExportConfig): ISAFTFile {
    ...
    return {
      header: {
        ...
        productID: config.softwareInfo.name,
        productVersion: config.softwareInfo.version,
        headerComment: 'Ficheiro SAFT gerado pelo Sistema Complexo Abilio Junqueira'
      },
      masterFiles: {
...
<AuditFile xmlns="urn:OECD:StandardAuditFile-Tax:AO_1.04_01">
  <Header>
    ...
    <ProductID>Complexo Abilio Junqueira-SAFT</ProductID>
