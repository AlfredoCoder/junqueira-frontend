...
import { useCreateTipoServico, ITipoServicoInput } from '@/hooks/useCreateTipoServico';
...
export default function AddService() {
  ...
  const { codigo_Utilizador: currentUserId } = useCurrentUser();
  
  const [formData, setFormData] = useState<ITipoServicoInput>({
    designacao: '',
    preco: 0,
    descricao: '',
    codigo_Utilizador: currentUserId || 1, // Usar utilizador atual ou fallback
  ...
  return (
    <div className="space-y-6 ultra-fast-fade">
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              >
                {creating ? (
                  <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white mr-2 loading-spinner" />
                ) : (
      ...
      {/* Formulário */}
      <div className="space-y-8 ultra-fast-fade">
        {createError && (
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setFormData({...formData, codigo_Classe: e.target.value ? parseInt(e.target.value) : null})}
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Deixe em branco para aplicar a todas as classes
                  </p>
                </div>
                <div>
                  <label className="block text-sm font-semibold text-foreground mb-2">
                  ...
                  <select
                    ...
                    onChange={(e) => setFormData({...formData, codigo_Curso: e.target.value ? parseInt(e.target.value) : null})}
                    className="w-full h-12 px-4 border border-border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-background text-foreground"
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="mt-2 text-sm text-blue-700">
                      <p>
                        • Se nenhuma classe/curso for selecionado, o serviço será aplicável a todos<br/>
                        • Se uma classe específica for selecionada, o serviço será restrito a essa classe<br/>
                        • Se um curso específico for selecionado, o serviço será restrito a esse curso
                      </p>
                    </div>
                  </div>
                </div>
