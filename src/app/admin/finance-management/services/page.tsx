...
import { 
  useFinanceServicesOptimized as useTiposServicos,
  useCreateFinanceServiceOptimized as useCreateTipoServico,
  useUpdateFinanceServiceOptimized as useUpdateTipoServico
} from '@/hooks/useFinanceOptimized';
import { useDeleteTipoServico, useRelatorioFinanceiro } from '@/hooks/useFinancialService';
...
export default function ServicesPage() {
  ...
  const { services: allTiposServicos, loading, error, pagination, refetch } = useTiposServicos(currentPage, itemsPerPage, debouncedSearchTerm);
  ...
  const handleViewService = useCallback((serviceId: number) => {
    router.push(`/admin/finance-management/services/details/${serviceId}`);
  }, []);
  const handleEditService = useCallback((serviceId: number) => {
    ...
    <div className="space-y-6 ultra-fast-fade">
          ...
          {loading && (
            <div className="flex items-center justify-center py-12">
              <div className="text-center">
                <Loader2 className="h-12 w-12 animate-spin text-[#F9CD1D] mx-auto mb-4 loading-spinner" />
                ...
                {allTiposServicos?.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={9} className="text-center py-12">
                      <div className="flex flex-col items-center space-y-4 ultra-fast-fade">
      ...
      <Dialog open={showDeleteModal} onOpenChange={setShowDeleteModal}>
        <DialogContent>
          ...
          <div className="py-4 space-y-3 ultra-fast-fade">
