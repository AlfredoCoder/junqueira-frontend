...
export default function HoursPage() {
  ...
  const handleViewSchedule = useCallback((scheduleId: number) => {
    window.location.href = `/admin/academic-management/hours/details/${scheduleId}`;
  }, []);
  const handleEditSchedule = useCallback((scheduleId: number) => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-8">
        ...
        {horariosPorPeriodo.map((stat, index) => {
          const colors = [
            ...
            { bg: "from-amber-50 via-white to-yellow-50/50", icon: "from-[#FFD002] to-[#F5DEB3]", text: "text-[#FFD002]" },
