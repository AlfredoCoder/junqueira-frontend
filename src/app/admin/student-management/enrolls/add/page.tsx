...
export default function AddEnrollmentPage() {
  ...
  const onSubmit = async (data: MatriculaFormData) => {
    ...
    const codigoUtilizador = selectedStudent.codigo_Utilizador || selectedStudent.tb_utilizadores?.codigo;
    if (!codigoUtilizador) {
      console.error('Código de utilizador não encontrado para o estudante');
      return;
    }
                  ...
                  <div className="space-y-4 ultra-fast-fade">
                    <div className="space-y-2 ultra-fast-fade">
                      ...
                      <div className="relative">
                        ...
                        {loadingSearch && (
                          <Loader2 className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 h-4 w-4 animate-spin loading-spinner" />
                        )}
                        <Input
