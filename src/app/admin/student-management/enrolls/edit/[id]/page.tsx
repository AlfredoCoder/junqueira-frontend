      ...
      <div className="space-y-6 ultra-fast-fade">
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            <Loader2 className="h-8 w-8 animate-spin mx-auto text-[#F9CD1D] mb-4 loading-spinner" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-6 lg:space-y-0 ultra-fast-fade">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              >
                {updateLoading ? (
                  <>
                    <Loader2 className="w-5 h-5 mr-2 animate-spin loading-spinner" />
                    Atualizando...
                  </>
                ) : (
                  <>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-2 ultra-fast-fade">
                ...
                <div className="relative">
                  ...
                  />
                  {loadingSearch && (
                    <Loader2 className="absolute right-3 top-1/2 transform -translate-y-1/2 h-4 w-4 animate-spin text-gray-400 loading-spinner" />
                  )}
                </div>
                  ...
                  <div className="absolute z-50 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg max-h-64 overflow-y-auto">
                    {loadingSearch ? (
                      <div className="p-4 text-center">
                        <Loader2 className="h-5 w-5 animate-spin mx-auto text-gray-400 loading-spinner" />
                      ...
                      {coursesLoading ? (
                        <SelectItem value="loading" disabled>
                          <div className="flex items-center">
                            <Loader2 className="h-4 w-4 mr-2 animate-spin loading-spinner" />
                            Carregando cursos...
                          </div>
                        </SelectItem>
                      ) : courses?.map((course) => (
                    ...
                    <SelectContent>
                      {statusLoading ? (
                        <div className="p-2 text-center text-gray-500">
                          <Loader2 className="h-4 w-4 animate-spin inline mr-2 loading-spinner" />
                          Carregando status...
                        </div>
