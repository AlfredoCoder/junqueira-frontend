...
export default function ListStudentPage() {
  ...
  useEffect(() => {
    getAllStudents(currentPage, itemsPerPage, debouncedSearchTerm, statusFilter, courseFilter);
  }, [currentPage, itemsPerPage, debouncedSearchTerm, statusFilter, courseFilter, getAllStudents]);
  ...
  const handleDeleteClick = useCallback((student: typeof students[0]) => {
    setStudentToDelete({
