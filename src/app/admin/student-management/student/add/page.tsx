...
export default function AddStudentPage() {
  ...
  const handleSkipBI = useCallback(() => {
    setShowBIModal(false);
    setBiData(null);
  }, []);
    ...
    <div className="space-y-6 ultra-fast-fade">
      ...
      <Dialog open={showBIModal} onOpenChange={setShowBIModal}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 py-4 ultra-fast-fade">
            ...
            {biData && !biData.error && (
              <div className="p-4 bg-green-50 dark:bg-green-950 rounded-lg border border-green-200 dark:border-green-800 space-y-2 ultra-fast-fade">
                <div className="flex items-center gap-2 text-green-700 dark:text-green-300 font-medium">
                  <CheckCircle className="h-4 w-4" />
                  <span>Dados encontrados!</span>
                </div>
                <div className="text-sm space-y-1 text-green-900 dark:text-green-100 ultra-fast-fade">
      ...
      <div className="space-y-4 sm:space-y-6 ultra-fast-fade">
