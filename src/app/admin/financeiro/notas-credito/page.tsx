...
import { 
  useCreditNotesOptimized as useCreditNotes,
  useCreateCreditNoteOptimized as useCreateCreditNote
...
const NotasCreditoPage = () => {
  ...
  // O hook otimizado já carrega os dados automaticamente
  // useEffect removido - dados carregados pelo hook

  // Handlers
  const handleViewDetails = useCallback((creditNote: CreditNote) => {
          ...
          {selectedCreditNote && (
            <div className="space-y-6 ultra-fast-fade">
              ...
              <div className="bg-yellow-50 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm ultra-fast-fade">
                  <div>
