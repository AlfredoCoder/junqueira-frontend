...
const mockProfessores = [
  { id: "1", nome: "Prof. João Silva Santos", especialidade: "Matemática", email: "joao.silva@Complexo Abilio Junqueira.com" },
  { id: "2", nome: "Prof. Maria Santos Costa", especialidade: "Física", email: "maria.santos@Complexo Abilio Junqueira.com" },
  { id: "3", nome: "Prof. Carlos Mendes Lima", especialidade: "Química", email: "carlos.mendes@Complexo Abilio Junqueira.com" },
  { id: "4", nome: "Prof. Ana Paula Francisco", especialidade: "Biologia", email: "ana.francisco@Complexo Abilio Junqueira.com" },
  { id: "5", nome: "Prof. Pedro Silva Neto", especialidade: "Língua Portuguesa", email: "pedro.silva@Complexo Abilio Junqueira.com" },
  { id: "6", nome: "Prof. Carla Lima Santos", especialidade: "História", email: "carla.lima@Complexo Abilio Junqueira.com" },
];
...
export default function AddDirectorTurmaPage() {
  ...
  return (
    <div className="space-y-6 ultra-fast-fade">
      ...
      {/* Formulário */}
      <div className="max-w-6xl mx-auto space-y-8 ultra-fast-fade">
