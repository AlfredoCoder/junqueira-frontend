...
export default function EditDirectorTurma() {
  ...
  const professoresData = [
    { id: "1", nome: "Prof. Maria Silva Santos", email: "maria.santos@Complexo Abilio Junqueira.edu.ao", formacao: "Licenciatura em Informática", especialidade: "Gestão de Sistemas" },
    { id: "2", nome: "Prof. João Manuel Costa", email: "joao.costa@Complexo Abilio Junqueira.edu.ao", formacao: "Licenciatura em Contabilidade", especialidade: "Gestão Financeira" },
    { id: "3", nome: "Prof. Ana Paula Francisco", email: "ana.francisco@Complexo Abilio Junqueira.edu.ao", formacao: "Licenciatura em Administração", especialidade: "Gestão Empresarial" },
    { id: "4", nome: "Prof. Carlos Alberto Neto", email: "carlos.neto@Complexo Abilio Junqueira.edu.ao", formacao: "Licenciatura em Economia", especialidade: "Análise Econômica" }
  ];
  ...
  const directorsData = [
    {
      ...
      email: "maria.santos@Complexo Abilio Junqueira.edu.ao",
    ...
    },
    {
      ...
      email: "joao.costa@Complexo Abilio Junqueira.edu.ao",
  ...
  const handleInputChange = useCallback((field: keyof DirectorTurmaFormData, value: string | number) => {
    setFormData(prev => ({
      ...prev,
      [field]: value
    }));
  }, []);
  const handleProfessorChange = useCallback((professorNome: string) => {
      ...
      <div className="space-y-6 ultra-fast-fade">
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#F9CD1D] mx-auto mb-4 loading-spinner"></div>
  ...
  return (
    <div className="space-y-6 ultra-fast-fade">
      ...
      <div className="max-w-4xl mx-auto space-y-8 ultra-fast-fade">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-2 ultra-fast-fade">
                ...
                <Input
                  ...
                  placeholder="email@Complexo Abilio Junqueira.edu.ao"
                  readOnly
