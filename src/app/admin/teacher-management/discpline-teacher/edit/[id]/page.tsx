...
export default function EditDisciplineTeacher() {
  ...
  const professoresData = [
    { id: "1", nome: "Prof. Maria Silva Santos", especialidade: "Matemática", email: "maria.santos@Complexo Abilio Junqueira.edu.ao" },
    { id: "2", nome: "Prof. João Manuel Costa", especialidade: "Português", email: "joao.costa@Complexo Abilio Junqueira.edu.ao" },
    { id: "3", nome: "Prof. Ana Paula Francisco", especialidade: "Inglês", email: "ana.francisco@Complexo Abilio Junqueira.edu.ao" },
    { id: "4", nome: "Prof. Carlos Alberto Neto", especialidade: "Física", email: "carlos.neto@Complexo Abilio Junqueira.edu.ao" },
    { id: "5", nome: "Prof. Beatriz Santos Silva", especialidade: "Química", email: "beatriz.silva@Complexo Abilio Junqueira.edu.ao" }
  ];
  ...
  const handleInputChange = useCallback((field: keyof DisciplineTeacherFormData, value: string | number | string[]) => {
    setFormData(prev => ({
      ...prev,
      [field]: value
    }));
  }, []);
  const handleDisciplinaChange = useCallback((disciplinaNome: string) => {
  ...
  const handleDiaSemanaChange = useCallback((dia: string, checked: boolean) => {
    setFormData(prev => ({
      ...prev,
      diasSemana: checked 
        ? [...prev.diasSemana, dia]
